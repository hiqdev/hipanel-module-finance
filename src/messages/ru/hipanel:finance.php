...
return [
    ...
    'Total' => 'Всего',
    'Month' => 'Месяц',
    'Take out charges' => 'Выбрать только детализацию',
    'Generate invoice' => 'Создать счет',
    'Prepare invoice' => 'Подготовить счет',
    'If left blank, the default value will be taken' => 'Если оставить пустым, будет взято значение по умолчанию',
    ...
    'No templates for the requisite. Follow this link {contactUrl} and set a template of type \'{type}\'' => 'Нет шаблонов для реквизита. Перейдите по этой ссылке {contactUrl} и установите шаблон типа \'{type}\'',
    'No templates for the requisite. Please contact the finance department' => 'Нет шаблонов для реквизита. Пожалуйста, свяжитесь с финансовым отделом',
...
<p>После нажатия кнопки <span class="label label-success">Импортировать</span>, вы будете передресованы на страницу создания платежей для проверки и подтверждения импорта.</p>',
    ...
    'Installment plans' => 'Планы на выплату',
    'Installment plan' => 'План на выплату',
    'Installment plans have been processed' => 'Планы на выплату обработаны',
    'Installment plan has been deleted' => 'План на выплату удален',
    'Installment plan has been restored' => 'План на выплату восстановлен',
    'An error occurred when trying to delete installment plan' => 'Произошла ошибка при попытке удалить план на выплату',
    'Are you sure you want to delete this installment plan?' => 'Вы уверены, что хотите удалить этот план на выплату?',
    'Are you sure you want to process all installment plans?' => 'Вы уверены, что хотите обработать все планы на выплату?',
    'Are you sure you want to restore these installment plans?' => 'Вы уверены, что хотите восстановить эти планы на выплату?',
    ...
    'Installment payment' => 'Выплата по рассрочке',
    'Periods' => 'Периоды',
