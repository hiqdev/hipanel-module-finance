...
<p>После нажатия кнопки <span class="label label-success">Импортировать</span>, вы будете передресованы на страницу создания платежей для проверки и подтверждения импорта.</p>',
    ...
    'Server traffic OUT' => '',
    'Server traffic 95% OUT' => '',
    'Server traffic 95% IN' => '',
    'Server 95 traffic overuse' => '',
    'Server traffic IN' => '',
    'Server traffic overuse' => '',
    ...
    'Refund' => 'Возвращение денег',
    'Uninstall' => 'Удаление',
    'Unuse' => 'Возврат средств',
    ...
    'PST' => '',
    'Trade' => 'Сделка',
    'Transaction fee' => 'Комиссия на перевод',
